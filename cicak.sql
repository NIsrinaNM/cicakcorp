...
--
-- Host: localhost
-- Generation Time: May 21, 2017 at 07:18 PM
...
(1, 'admin', '12345', 'DM Candra', '2017-04-28 14:53:07');
...
(7, 5, '23WER', 3, '541000', 'warna warni yaa'),
(8, 5, 'MWA123', 1, '123000', ''),
(9, 6, '23WER', 3, '541000', 'warna warni yaa'),
(10, 7, '123AA', 4, '1332436', ''),
(11, 8, '123AA', 3, '1332436', ''),
(12, 9, '23WER', 2, '541000', ''),
(15, 11, '23WER', 3, '541000', '');
...
--
-- Table structure for table `jenisjasa`
--

CREATE TABLE IF NOT EXISTS `jenisjasa` (
  `id` char(3) NOT NULL,
...
--
-- Dumping data for table `jenisjasa`
--
...
(3, 'Baju Polo ITS', 'PAKAIAN', '112500', '121', 'Ukuran yang tersedia\r\n-L\r\n-XL\r\n-S', 'Tidak tesedia', '100', 'uploads/JUALAN_3ASE1.jpg', '3ASE'),
(5, 'Sepatu casual NIKE', 'SEPATU', '541000', '250', 'barang masih banyak gan.\r\nUkuran yang ada 36-41\r\nWarna merah biru hitam', 'Tesedia', '10', 'uploads/JUALAN_23WER.jpeg', '23WER'),
(15, 'Jaket kulit ITS', 'JAKET', '123000', '100', 'Ukuran yang tersedia \r\nx\r\nl\r\nxl\r\nm\r\ns', 'Tesedia', '20', 'uploads/JUALAN_MWA123.jpeg', 'MWA123'),
(16, 'Pompa Ban ITS', 'JAKET', '1332436', '1,00', 'Upload gambar\r\n\r\nGunakan foto terbaik untuk menunjang penjualan anda. (JPEG, JPG, PNG)', 'Tesedia', '10', 'uploads/JUALAN_123AA.JPG', '123AA');
...
(24, 'uploads/JUALAN_NOTHUMB_0_123AA.jpg', '123AA'),
(25, 'uploads/JUALAN_NOTHUMB_1_123AA.jpg', '123AA');
...
INSERT INTO `order` (`id`, `date`, `customer`, `kode_order`, `metode`, `biaya`, `subtotal`, `alamat`, `read`, `status_bayar`) VALUES
(5, '2017-04-30 22:20:16', 'user1', '24306719732', 'COD', '22000', '664000', 'balung bendo', 0, 'Sudah Dibayar'),
(6, '2017-05-01 17:00:00', 'user1', '60216640568', 'COD', '0', '1623000', 'balung bendo', 0, 'Order Selesai'),
(7, '2017-05-05 17:00:00', 'user1', '43873642310', 'JNE', '0', '5329744', 'Jalan jalan no 100', 0, 'Belum dibayar'),
(8, '2017-05-17 17:00:00', 'user1', '74225066168', 'COD', '0', '3997308', 'jalan bendo balung 1', 0, 'Belum dibayar'),
(9, '2017-05-20 00:00:00', 'user2', '95040190746', 'COD', '0', '1082000', 'Jalan bambu No 1, WINONG, KABUPATEN PATI, JAWA TENGAH 0980', 0, 'Belum dibayar'),
(11, '2017-05-20 07:28:56', 'user1', '98854457675', 'COD', '0', '1623000', 'Jalan bambu No 3, SAMBIKEREP, KOTA SURABAYA, JAWA TIMUR 60111', 0, 'Belum dibayar');

-- --------------------------------------------------------

--
-- Table structure for table `orderanjasa`
--

CREATE TABLE IF NOT EXISTS `orderanjasa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `read` int(11) NOT NULL DEFAULT '1',
  `kode` varchar(10) NOT NULL,
  ...
  `metod` varchar(15) NOT NULL,
  `total` varchar(100) NOT NULL DEFAULT '0',
  `statusorder` varchar(100) NOT NULL DEFAULT 'Belum Dibayar',
  PRIMARY KEY (`id`),
  UNIQUE KEY `kode` (`kode`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `orderanjasa`
--

INSERT INTO `orderanjasa` (`id`, `read`, `kode`, `username`, `tanggal`, `namabarang`, `jenisbarang`, `jumlah`, `deskripsi`, `desain`, `nama`, `alamat`, `notelp`, `metod`, `total`, `statusorder`) VALUES
(1, 0, 'Wd1H895', 'user1', '2017-05-15 17:10:14', 'BLOCKNOTE', 'A5', 21, 'Block note sebanya beberapa buah', 'assets/orderan/', 'Burhan', 'balung bendo', '027273727', 'JASA', '0', 'Sedang Dikerjakan'),
(2, 0, 'kDZLlc2', 'user1', '2017-05-17 04:26:22', 'STICKER Cutting', '', 90, 'No description, website, or topics provided. ', 'assets/orderan/CUSTOM_ORDER_kDZLlc2', 'Burhan Med', 'Jalan bambu No 3, SAMBIKEREP, KOTA SURABAYA, JAWA TIMUR - 60111', '027273727', 'COD', '0', 'Belum Dibayar'),
(3, 0, 'cKUU8Ne', 'user1', '2017-05-17 04:30:31', 'BLOCKNOTE A5', '', 11, 'No description, website, or topics provided. ', 'assets/orderan/CUSTOM_ORDER_cKUU8Ne', 'Burhan Med', 'Jalan bambu No 3, SAMBIKEREP, KOTA SURABAYA, JAWA TIMUR - 60111', '027273727', 'COD', '0', 'Belum Dibayar'),
(4, 0, '5iux11S', 'user1', '2017-05-17 04:31:31', 'BLOCKNOTE A5', '', 1, 'No description, website, or topics provided. ', 'assets/orderan/CUSTOM_ORDER_5iux11S.zip', 'Burhan Med', 'Jalan bambu No 3, SAMBIKEREP, KOTA SURABAYA, JAWA TIMUR - 60111', '027273727', 'COD', '0', 'Belum Dibayar'),
(5, 0, 's5EezGg', 'user1', '2017-05-17 04:35:43', 'PIN 58mm glossy', '', 12, 'No description, website, or topics provided. ', 'assets/orderan/CUSTOM_ORDER_s5EezGg.zip', 'Burhan Med', 'Jalan bambu No 3, SAMBIKEREP, KOTA SURABAYA, JAWA TIMUR - 60111', '027273727', 'COD', '0', 'Belum Dibayar'),
(6, 0, 'pTPBmuW', 'user1', '2017-05-18 10:20:06', 'BLOCKNOTE A6', '', 3, 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', 'assets/orderan/CUSTOM_ORDER_pTPBmuW.zip', 'Burhan Med', 'Jalan bambu No 3, SAMBIKEREP, KOTA SURABAYA, JAWA TIMUR - 60111', '027273727', 'COD', '0', 'Telah Dikirim'),
(7, 0, 'h2zrfTh', 'user1', '2017-05-20 09:27:18', 'PIN 58mm kanvas', '', 1, 'qwqwqeeeeeeeeeee qqqqqqqqqq eeeeeeee', 'assets/orderan/CUSTOM_ORDER_h2zrfTh.zip', 'Burhan Med', 'Jalan bambu No 3, SAMBIKEREP, KOTA SURABAYA, JAWA TIMUR - 60111', '027273727', 'COD', '0', 'Belum Dibayar');
...
CREATE TABLE IF NOT EXISTS `profile` (
  ...
  `foto` varchar(255) DEFAULT 'fotokosong.jpg',
  `prop` varchar(50) DEFAULT NULL,
  `kotkab` varchar(50) DEFAULT NULL,
...
INSERT INTO `profile` (`uid`, `username`, `nama`, `alamat`, `kodepos`, `noTelp`, `foto`, `prop`, `kotkab`, `kec`) VALUES
(3, 'user1', 'Burhan Med', 'Jalan bambu No 3', '60111', '027273727', 'assets/fotouser/', 'JAWA TIMUR', 'KOTA SURABAYA', 'SAMBIKEREP'),
(4, 'user2', 'Azzul', 'Jalan bambu No 1', '0980', '0987654', 'assets/fotouser/', 'JAWA BARAT', 'KABUPATEN PURWAKARTA', 'WANAYASA');
...
(2, 'user1', 'BLOCKNOTE', 'A5', 1, 'Setiap desain dibuat satu saja ukuran A4, ini ada 5 desain, jadi total ada 5 ya', 'assets/orderan/', 'Hubungi Kami', 'JASA');
...
INSERT INTO `user` (`id`, `username`, `email`, `password`, `timestamp`, `verify`) VALUES
(3, 'user1', 'aaa@gmail.com', '2db820227dbbdce8911a9f9d10bcf58f', '2017-05-04 01:07:07', 0),
(4, 'user2', 'email@kusia.ga', '2db820227dbbdce8911a9f9d10bcf58f', '2017-05-19 13:05:02', 0);
